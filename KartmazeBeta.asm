...
ESPERALETRA
    ...
    LD R6,GUARDAR_CONT_ENEM
    ADD R6,R6,#-1
    ST R6,GUARDAR_CONT_ENEM 
    BRp NO_ENEMIGO
    ADD R6,R6,#2
    ST R6,GUARDAR_CONT_ENEM 
	ST R0,GUARDAR_AUTO
...
azul_claro .FILL x189F  ; 0 001 1000 0010
azul_osc .FILL x084A
abajo.FILL #256
subir.FILL #-256
columna.FILL x00FF
...
LD R6,GUARDAR_AUTO
ST R6,GUARDAR_AUTO
AND R3, R0,R2 ; R3 CORD Y ENEMIGO
AND R4, R6,R2  
NOT R4,R4
ADD R4,R4,#1
ADD R4, R4,R3 ;R4= CORD Y ENEM - CORD Y AUTO
BRn BAJAR
BRp SUBIR
BRz EJEX
BAJAR
LD R5,ancho_pantalla
ADD R0,R0,R5
BRnzp TERMINA_DIRECCIONAR1
SUBIR
LD R5,ancho_pantalla_neg
ADD R0,R0,R5
BRnzp TERMINA_DIRECCIONAR1

EJEX
AND R3, R0,R1 ; r3 CORD x ENEMIGO
AND R4, R6,R1
NOT R4,R4
ADD R4,R4,#1
ADD R4, R4,R3
BRn izq
BRp der
BRz TERMINA_DIRECCIONAR2
der
ADD R0,R0,#-1
BRnzp TERMINA_DIRECCIONAR2
izq
ADD R0,R0,#1
BRnzp TERMINA_DIRECCIONAR2


TERMINA_DIRECCIONAR1
LD R3,diez
ADD R3,R3,#0
COLISIONA
ADD R4,R4,R5
...
ADD R3,R3,#-1
BRp COLISIONA4
BRnz TERMINA_DIRECCIONAR


TERMINA_DIRECCIONAR2
LD R3,diez
ADD R3,R3,#2
COLISIONA5
ADD R4,R4,#-1
